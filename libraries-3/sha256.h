...
static inline void sha256_transform(sha256_ctx_t *ctx, const uint8_t data[64]) {
...
static inline void sha256_update(sha256_ctx_t *ctx, const void *data_in, size_t len) {
...
static inline void sha256_final(sha256_ctx_t *ctx, uint8_t digest[32]) {
    size_t buffer_idx = (size_t)(ctx->count & 63);
